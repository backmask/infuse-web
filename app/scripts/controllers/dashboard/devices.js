...
angular.module('infuseWebApp')
  .controller('DevicesCtrl', function ($scope, gatewayManager) {
    ...
    $scope.families = [
      ...
      { id: 'sensor.temperature', name: 'Thermometer', icon: '<img src="images/thermometer.png" />' },
    ...
    $scope.sensors = [
      ...
      { id: 'acceleration', name: 'Accelerometer', icon: '<img src="images/accelerometer.png" />' },
      { id: 'gyroscope', name: 'Gyroscope', icon: '<img src="images/gyroscope.png" />' },
      { msGroup: false },
      ...
      { id: 'barometer', name: 'Barometer', icon: '<img src="images/barometer.png" />' },
      { id: 'temperature', name: 'Temperature', icon: '<img src="images/thermometer.png" />' },
      { msGroup: false }
    ].map(fillDefaultIcon);
